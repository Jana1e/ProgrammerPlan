...
@section('content')
                ...
                <div id="carouselExampleCaptions" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{uploaded_asset($event->image) }}" alt="{{ $event->name }}" class="img-fluid"
                                alt="banner">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="events_starts">
                                    ...
                                    <h3 class="mt-1">{{ $event->name }}</h3>
                                    <small>


                                        {{ \Carbon\Carbon::parse($event->start_date)->format('l, F jS \\a\\t g:i A') }}
                                        ({{ $event->location }})</p>
                            ...
                            <div class="col-lg-7 position-relative z-1">
                                ...
                                <div class="modal fade edit-form  d-none" id="form" tabindex="-1"
    ...
    <script>
        ...
        const eventDate = new Date("{{ \Carbon\Carbon::parse($event->start_date)->format('Y-m-d H:i:s') }}").getTime();
