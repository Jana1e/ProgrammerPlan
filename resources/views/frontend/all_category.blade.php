                                ...
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                    ...
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M3 16.5L12 21.75L21 16.5" stroke="#6E7485" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M3 12L12 17.25L21 12" stroke="#6E7485" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M3 7.5L12 12.75L21 7.5L12 2.25L3 7.5Z" stroke="#6E7485"
                                    ...
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path opacity="0.2"
                                                ...
                                                fill="#6E7485" />
                                            <path d="M9 14.25H15" stroke="#6E7485" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M9 11.25H15" stroke="#6E7485" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                    ...
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="#6E7485" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M15 21H9" stroke="#6E7485" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M15 11.25L10.5 8.25V14.25L15 11.25Z" stroke="#6E7485"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                                ...
                                                <div class="course_headinfg">
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        ...
                                                        <path
                                                            ...
                                                            fill="url(#paint0_linear_201_8073)" />
                                                        <defs>
                                                            <linearGradient id="paint0_linear_201_8073" x1="10"
                                                                y1="1.875" x2="10" y2="17.5"
                                                ...
                                                <div class="str_rate">
                                                    ...
                                                    <div class="filter ">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                            ...
                                                            <li><a class="dropdown-item active" href="add_course.php"
                                                                    target="_blank">View Course Details</a></li>
                                                            <li><a class="dropdown-item" href="about_course.php"
                                ...
                                <section class="banner_slider">
                                    <div class="container-xxl p-lg-0 ">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-12 mb-3">
                                                ...
                                                <div class="card_shadow shadow_sec_padd">
                                                    <div class="d-flex justify-content-between mb-3">
                                                        ...
                                                        <div class="heading_sec">
                                                            <a href="courses.php" class="see_all_text"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6 mb-3">
                                                            <div class="cards_courses">
                                                                <img src="../assets/img/c01.png" alt="c1"
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div class="course_headinfg">
                                                                        <svg width="20" height="20"
                                                                            ...
                                                                            <defs>
                                                                                <linearGradient id="paint0_linear_201_8073"
                                                                                    x1="10" y1="1.875"
                                                                                    x2="10" y2="17.5"
                                                                                    gradientUnits="userSpaceOnUse">
                                                                                    <stop stop-color="#59B5C6"></stop>
                                                                                    <stop offset="1"
                                                                                        stop-color="#0A2B7D"></stop>
                                                                                </linearGradient>
                                                                            </defs>
                                                                        </svg>
                                                                ...
                                                                <div class="d-flex gap-4 flex-wrap mt-3">
                                                                    ...
                                                                    <div>
                                                                        <span class="text-gray-600 text-13">Created by <a
                                                                                href="#"
                                                                                class="fw-semibold text-gray-700 hover-text-main-600 hover-text-decoration-underline text-dark">Albert
                                                                                James</a> </span>
                                                                        <div class="d-flex gap-4">
                                                                            <span
                                                                                class="text-15 fw-bold text-warning-600 d-flex"><i
                                                                                    class="bi bi-star-fill"
                                                                                    style="color: #FF9F43;
                                        font-size: 12px;"></i>
                                                                            </span>
                                                                            <span
                                                                                class="text-13 fw-bold text-gray-600">4.9</span>
                                                                            <span
                                                                                class="text-13 fw-bold text-gray-600">(12k)</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6 mb-3">
                                                            <div class="cards_courses">
                                                                <img src="../assets/img/c2.png" alt="c1"
                                                                    class="img-fluid w-100 mb-2">
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="course_heading">
                                                                        <h4>UI/UX</h4>
                                        ...
                                        font-size: 12px;"></i>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6 mb-3">
                                                            <div class="cards_courses">
                                                                <img src="../assets/img/c3.png" alt="c1"
                                                                    class="img-fluid w-100 mb-2">
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="course_heading">
                                                                        <h4>Coding</h4>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                ...
                                                <div class="progrees_home ">
                                                            ...
                                                            <div class="filter ">
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li><a class="dropdown-item active"
                                                                            href="add_course.php" target="_blank">View
                                                                            Course Details</a></li>
                                                                    <li><a class="dropdown-item" href="about_course.php"
                                                                            target="_blank">About Teacher</a></li>
                                                                    <li><a class="dropdown-item" href="courses.php"
                                                    ...
                                                    <div class="work_progress">
                                                        ...
                                                        <p class="text-dark text-start " style="font-size: 13px;">Lorem
                                                            ipsum dolor sit amet consectetur adipisicing elit. Quidem
                                                            dignissimos mollitia in quis at voluptas corrupti.</p>
                                                        <div class="progress" role="progressbar"
                                                            aria-label="Example with label" aria-valuenow="25"
                                                            aria-valuemin="0" aria-valuemax="100">
                                                            <div class="progress-bar" style="width: 50%">50%</div>
