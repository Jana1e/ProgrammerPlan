                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="digital" onchange="categoriesByType(this.value)" required class="form-control aiz-selectpicker mb-2 mb-md-0">
                                <option value="0" @if ($category->digital == '0') selected @endif>{{translate('Course')}}</option>
                                <option value="1" @if ($category->digital == '1') selected @endif>{{translate('Service')}}</option>
                                <option value="2" @if ($category->digital == '2') selected @endif>{{translate('Event')}}</option>
