            ...
            <div class="card-body">
                <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="datetime-local" placeholder="{{translate('Start Date & Time')}}" id="start_date" name="start_date" class="form-control" required>
                        </div>
                    </div>   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="url" placeholder="{{translate('Registration Link')}}" id="registration_link" name="registration_link" class="form-control" required>
                        </div>
                    </div>
