...
<script type="text/javascript">
    class SectionManager {
        ...
        async updateSectionOrder() {
            ...
            try {
                const response = await fetch('/admin/sections/reorder', {
                    method: 'POST',
                    headers: {
        ...
        <li class="list-inline-item">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#" data-type="Quiz"    data-bs-toggle="modal" data-bs-target="#quizModal"     >Quiz</a></li>
...
if(contentType=="Quiz")
{
var userTyp = document.getElementById('lecture_id_model');
    if (userTyp) {
        userTyp.value = this.id ;
    }
...
<script type="text/javascript">
     ...
     function openEditSectionModal(sectionElement, sectionId) {
        ...
        function updateSection(sectionId, sectionName, sectionOrder) {
            ...
            $.ajax({
                url: `/admin/sections/${sectionId}`, // URL يعتمد على `Route::resource`
                type: 'PUT',
                data: {
                    name: sectionName,
                    order: sectionOrder,
        ...
        function deleteSection(section, sectionId) {
            ...
            $.ajax({
                url: `/admin/sections/${sectionId}`, // URL لحذف القسم بناءً على معرفه
