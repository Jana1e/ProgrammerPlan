...
class CategoryController extends Controller
{
    ...
    public function categoriesByType(Request $request)
    {
        ...
        return view('backend.categories.categories_option', compact('categories'));
    }
    ...
    public function categoriesWiseProductDiscount(Request $request){
        ...
        $categories = $categories->paginate(15);
        return view('backend.category_wise_discount.set_discount', compact('categories', 'sort_search'));
    }
}
