...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.teacher.products.index', compact('products', 'search'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        return view('frontend.teacher.products.create', compact('categories'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('frontend.teacher.products.edit', compact('product', 'categories', 'tags', 'lang'));
    }
