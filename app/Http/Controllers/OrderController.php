...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            $order->seller_id = $request->receiver_id; 
            $order->additional_info = $request->message;
            $order->delivery_viewed = '0'; // Default value
            $order->payment_status_viewed = '0'; // Default value
            $order->code = date('Ymd-His') . rand(10, 99); // Unique order code
            $order->date = $request->delivery_days; // Current timestamp
            $order->price = $request->offer_price  ; // Set price or 0 if product not found
            ...
            $order_notification['status'] = $order_status;
                    ...
                    $order_notification['notification_type_id'] = 2;
