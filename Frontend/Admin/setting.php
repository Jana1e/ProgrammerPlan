            ...
            <div class="card uplaod_profile_sec">
              ...
              <div class="mt-4">
                ...
                <a href="setting.php">
                  <div class="d-flex justify-content-between mb-3 ">
                    <div class="health_category">
                      <span class="ps-2  active"> Setting</span>
                    </div>
            ...
            <div class="profile_form">
              <div class=" mb-3">
                <div class="heading_sec">
                  <h2 class="main_heading">Setting</h2>
                </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="dropdown  bd-mode-toggle ">
                          <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center bg-transparent" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Toggle theme (light)">
